...
module.exports =
  clusters: 'vagrant': services:
    ...
    'ryba-ambari-takeover/metrics/service':
      options:
        hadoop_group: gid: 2400
        group: gid: 2461
        user: uid: 2461, gid: 2461
    'ryba-ambari-takeover/logsearch/service':
      options:
        hadoop_group: gid: 2400
        group: gid: 2462
        user: uid: 2462, gid: 2462
    'ryba-ambari-takeover/hadoop/hdfs':
      options:
        hadoop_group: gid: 2400
        group: gid: 2414
    ...
    'ryba-ambari-takeover/hadoop/yarn':
      options:
        yarn:
          group: gid: 2403
          user: uid: 2403, gid: 2403
    'ryba-ambari-takeover/hadoop/mapreduce':
      options:
        mapred:
          group: gid: 2404
          user: uid: 2404, gid: 2404
    # 'ryba-ambari-takeover/hadoop/httpfs':
    #   options:
    #     group: gid: 2427
    ...
    # 'ryba/ambari/retired/ganglia/collector':
    #   config: ryba: ganglia:
    #     rrdcached_group: gid: 2406
    #     rrdcached_user: uid: 2406, gid: 2406
    # 'ryba/ambari/retired/nagios':
    #   config: ryba: nagios:
    #     group: gid: 2418
    #     groupcmd: gid: 2419
    #     user: uid: 2418, gid: 2418
    # 'ryba-ambari-takeover/hadoop/kms':
    #   options:
    #     group: gid: 2453
    #     user: uid: 2453, gid: 2453
    # 'ryba-ambari-takeover/hive/hcatalog':
    #   options:
    #     group: gid: 2407
    #     user: uid: 2407, gid: 2407
    # 'ryba-ambari-takeover/hbase/master':
    #   options:
    #     group: gid: 2409
    #     user: uid: 2409, gid: 2409
    # 'ryba/ambari/huedocker':
    #   options:
    #     group: gid: 2410
    #     user: uid: 2410, gid: 2410
    # 'ryba-ambari-takeover/oozie/server':
    #   config: ryba: oozie:
    #     group: gid: 2411
    ...
    # 'ryba-ambari-takeover/knox/server':
    #   options:
    #     group: gid: 2420
    #     user: uid: 2420, gid: 2420
    # 'ryba/ambari/retired/falcon/server':
    #   config: ryba: falcon:
    #     group: gid: 2421
    #     user: uid: 2421, gid: 2421
    # 'ryba/ambari/elasticsearch':
    ...
    # 'ryba/ambari/kafka/broker':
    #   options:
    #     group: gid: 2424
    #     user: uid: 2424, gid: 2424
    # 'ryba-ambari-takeover/spark/client':
    #   options:
    #     group: gid: 2426
    #     user: uid: 2426, gid: 2426
    # 'ryba-ambari-takeover/spark/history_server':
    #   config: ryba: spark:
    #     group: gid: 2426
    #     user: uid: 2426, gid: 2426
    # 'ryba-ambari-takeover/spark/livy_server':
    #   config: ryba: spark:
    #     group: gid: 2426
    #     user: uid: 2426, gid: 2426
    # 'ryba/ambari/opentsdb':
    #   config: ryba: opentsdb:
    #     group: gid: 2428
    #     user: uid: 2428, gid: 2428
    # 'ryba/ambari/mongodb/configsrv':
    #   config: ryba: mongodb:
    #     group: gid: 2429
    ...
    'ryba/solr/cloud_docker':
      options:
        group: gid: 2432
        user: uid: 2432, gid: 2432
        hadoop_group: gid: 2400, name: 'hadoop'    # 'ryba-ambari-takeover/ranger/hdpadmin':
    #   options:
    #     group: gid: 2434
    #     user: uid: 2434, gid: 2434
    #     #need the same uid than ryba/ambari/solr/cloud if on the same node
    #     solr:
    #       group: gid: 2432
    #       user: uid: 2432, gid: 2432
    # # 'ryba/ambari/druid/base':
    # #   config: ryba: druid:
    # #     group: gid: 2435
    # #     user: uid: 2435, gid: 2435
    # 'ryba/ambari/smartsense/server':
    ...
    # 'ryba/ambari/phoenix/queryserver':
    #   config: ryba: phoenix:
    #     group: gid: 2441
    #     user: uid: 2441, gid: 2441
    # 'ryba-ambari-takeover/tez':
    #   config: ryba: tez:
    #     group: gid: 2447
    #     user: uid: 2447, gid: 2447
    # 'ryba/ambari/prometheus/monitor':
    #   config: ryba: prometheus: monitor:
    #     group: gid: 2459
    #     user: uid: 2459, gid: 2459
    # 'ryba/ambari/grafana/webui':
